...
<body>
    ...
    <?php include('phpElements/left-sidebar.php')?>
    ...
    <?php include('phpElements/slider.php') ?>
            ...
            <div class="text-in-main-box">
                ...
                <p class="head">Marat Kalimov
                <p class="head-color"> A Videographer.</p>
                <p class="head1">I Capture Life</p>

                <p class="descriptions">Hi, everybody! I am a Videographer from <u>Moscow</u> Far far away, behind the word mountains, far from the countries Vokalia and Consonantia, there live the blind texts. Separated they live in Bookmarksgrove right at the coast of the Semantics, a large language ocean.</p>
